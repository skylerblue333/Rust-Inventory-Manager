...
inventory manager in Rust.

## 🚀 Overview
This repository contains a professional implementation of **Rust Inventory Manager**. It is designed with clean code principles and focuses on functionality and reliability.
